# 구글 플레이 콘솔 광고/결제 설정 가이드 (Mental Math Trainer)

## 1. 현재 수익화 상태

| 항목 | 현재 상태 | 비고 |
| --- | --- | --- |
| 배너 광고 | 코드 준비됨 | 홈 화면 하단 — 출시 전 AdsBanner 위젯 추가 필요 |
| 전면 광고 | 적용됨 | 라운드 완료 직후 노출 |
| 보상형 광고 | 적용됨 | 보너스 라운드 버튼 탭 시 선택적 시청 |
