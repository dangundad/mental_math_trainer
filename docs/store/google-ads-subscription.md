## Google Play Console 인앱 상품 설정 (Mental Math Trainer - 무료 + 3단 후원형 프리미엄)
...
| --- | --- | --- | --- | --- |
| Small | `com.dangundad.mentalmathtrainer.premium_small` | `com.dangundad.mentalmathtrainer.premium.small` | $1.99 | 작은 후원, 광고 제거 |
| Medium | `com.dangundad.mentalmathtrainer.premium_medium` | `com.dangundad.mentalmathtrainer.premium.medium` | $4.99 | 인기 옵션, 광고 제거와 추가 후원 |
| Large | `com.dangundad.mentalmathtrainer.premium_large` | `com.dangundad.mentalmathtrainer.premium.large` | $9.99 | 광고 제거와 든든한 후원 |
...
- 상품 ID: `com.dangundad.mentalmathtrainer.premium_small`
- 태그: `premium`
- 이름 (영어): `A cup of coffee`
- 설명 (한국어): 광고 제거와 커피 한 잔 후원
- 설명 (영어): `Remove ads and support Mental Math Trainer`
- 구매 옵션 ID: `mentalmathtrainer-premium-small`
- 가격: 콘솔에서 국가별 최종 설정 (권장 `$1.99`)
- 상태: 활성화

**상품 2: Medium Premium (점심 한 끼)** - 인기/추천
- 상품 ID: `com.dangundad.mentalmathtrainer.premium_medium`
- 태그: `premium`
- 이름 (영어): `A lunch treat`
- 설명 (한국어): 광고 제거와 추가 후원
- 설명 (영어): `Remove ads and add extra support`
- 구매 옵션 ID: `mentalmathtrainer-premium-medium`
- 가격: 콘솔에서 국가별 최종 설정 (권장 `$4.99`)
- 상태: 활성화

**상품 3: Large Premium (든든한 후원)**
- 상품 ID: `com.dangundad.mentalmathtrainer.premium_large`
- 태그: `premium`
- 이름 (영어): `Full support`
- 설명 (한국어): 광고 제거와 든든한 후원
- 설명 (영어): `Remove ads and fully support development`
- 구매 옵션 ID: `mentalmathtrainer-premium-large`
...
abstract class PurchaseConstants {
  static const String PREMIUM_SMALL_ANDROID =
      'com.dangundad.mentalmathtrainer.premium_small';
  static const String PREMIUM_MEDIUM_ANDROID =
      'com.dangundad.mentalmathtrainer.premium_medium';
  static const String PREMIUM_LARGE_ANDROID =
      'com.dangundad.mentalmathtrainer.premium_large';
